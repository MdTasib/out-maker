...
const Navbar = () => {
	return (
		<>
			...
			{/* main menu */}
			<div className='p-0 px-10 shadow shadow-gray-200'>
				<div className='container mx-auto navbar relative'>
					...
					<div className='navbar-end pe-5'>
						...
						<span className='me-6 border-[#C3C3C3] border rounded-full p-1'>
							<GoPeople />
						</span>
						<span className='border-[#C3C3C3] border rounded-full p-1'>
							<PiHandbag />
						</span>
					</div>
				</div>
