...
const Footer = () => {
	return (
		<footer className='px-16  bg-[#262F3C] text-white'>
			<div className='container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0'>
				<div className='lg:w-2/5'>
					<img src={logo} alt='' className='w-20 p-2' />
					<div className='flex justify-start space-x-3'>
						<a
							...
							<svg
								...
								fill='currentColor'
								viewBox='0 0 32 32'
								className='w-7 h-7 bg-[#222A36] rounded-full p-2 fill-current'>
			...
			<div className='pb-4'>
				<div class='flex justify-between items-center bg-[#222A36] p-2 rounded'>
					<div>
						<p class='text-xs'>© 2023, OutMaker all right Reserved</p>
					</div>
